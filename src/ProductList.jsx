    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Lemongrass", image: "https://cdn.pixabay.com/photo/2020/05/22/16/53/lemongrass-5206915_1280.jpg", description: "Natural mosquito repellent with a citrus scent.", cost: "$11" }
            ]
        }
    ];
